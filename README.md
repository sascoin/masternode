...
`wget -q https://raw.githubusercontent.com/sascoin/masternode/master/install.sh`
***
...
***Step 1***
* Download and install the SASCoin wallet [here](https://github.com/investmentblockchain/SAS-Core/releases)
***

***Step 2***
* Send EXACLY 1,000 SAS to a receive address within your wallet.
***
